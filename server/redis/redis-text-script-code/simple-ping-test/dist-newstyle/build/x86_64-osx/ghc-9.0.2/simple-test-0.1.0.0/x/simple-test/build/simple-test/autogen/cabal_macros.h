...
/* package simple-test-0.1.0.0 */
#ifndef VERSION_simple_test
#define VERSION_simple_test "0.1.0.0"
#endif /* VERSION_simple_test */
#ifndef MIN_VERSION_simple_test
#define MIN_VERSION_simple_test(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_simple_test */
...
#define CURRENT_COMPONENT_ID "simple-test-0.1.0.0-inplace-simple-test"
